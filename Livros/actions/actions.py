...
class ActionBuscarPorTitulo(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict) -> List [Dict]:
        ...
        if not titulo:
            ...
            dispatcher.utter_message(text="qual e o titulo do livro que voce procura?")
            return []
        ...
        if data["numFound"] > 0:
            ...
            dispatcher.utter__message(text="aqui estao alguns resultados:\n"+"\n".join(mensagens))
        else:
...
class ActionBuscarPorAutor(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict) -> List [Dict]:
        ...
        if not autor:
            ...
            dispatcher.utter_message(text="qual e o autor do livro que voce procura?")
            return []
        ...
        if data["numFound"] > 0:
            ...
            dispatcher.utter__message(text="aqui estao alguns livros do autor:\n"+"\n".join(mensagens))
        else:
            dispatcher.utter_message(response="utter_erro_busca")
            return[]
